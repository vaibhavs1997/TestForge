...
export const LandingBackground: React.FC = () => (
  <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden>
    <div
      ...
      style={{
        background:
          'radial-gradient(ellipse 80% 50% at 50% -20%, rgba(79, 209, 197, 0.18), transparent), radial-gradient(ellipse 60% 40% at 100% 50%, rgba(127, 0, 255, 0.14), transparent), radial-gradient(ellipse 50% 30% at 0% 80%, rgba(79, 209, 197, 0.08), transparent), #0A192F',
      }}
    />
    <svg className="absolute inset-0 h-full w-full opacity-[0.15]" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="lineGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" stopColor="#4FD1C5" stopOpacity="0.6" />
      ...
      <circle cx="680" cy="280" r="3" fill="#4FD1C5" className="landing-node-pulse" />
      <circle cx="350" cy="380" r="2" fill="#4FD1C5" className="landing-node-pulse landing-line-delay" />
      <circle cx="900" cy="200" r="2" fill="#4FD1C5" className="landing-node-pulse" />
    </svg>
