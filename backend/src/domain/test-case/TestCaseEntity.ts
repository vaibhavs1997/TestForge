...
import type { GenerationProvenance } from '../requirements/TestDesignEntity.js';
import type { CoverageSummary } from '../../application/requirements/CoverageModel.js';

export interface TestCaseVersionContent { requirementId: string; acceptanceCriterionId?: string; operationId: string; scenarioIntent: string; payload: unknown; assertions: unknown; mapping: unknown; mutationProvenance?: unknown; generatedContent?: unknown; operationLabel?: string; protocol?: string; operationRisk?: string; baselineInput?: unknown; /** Immutable, sanitized generation snapshot. */ generationProvenance?: GenerationProvenance; /** Immutable coverage evidence/snapshot for this exact version when calculated. */ coverage?: Record<string, CoverageSummary>; /** Exact-version canonical input overrides; edits always create a new version. */ dataOverrides?: Record<string, unknown>; }
